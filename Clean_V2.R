...
#
# Purpose: To Clean all the needed data to get it read for merging
#
# Authors: Hugo Bonsey
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# For this data set the names have also been kept as the Scotish data set did not come with LAD codes
...
# the data set only provides population numbers so we need to calculate the percentage to compare with the other countries
...
# For example, checking missing values in UK_income_clean
